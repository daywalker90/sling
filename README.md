<table border="0">
  ...
  <tr>
    ...
    <td>
      <a href="https://github.com/daywalker90/sling/actions/workflows/master_v26.06.yml">
        <img src="https://github.com/daywalker90/sling/actions/workflows/master_v26.06.yml/badge.svg?branch=master">
      </a>
    </td>
  </tr>
</table>
...
and more info can be found on the [release](https://github.com/daywalker90/sling/releases) page. If you are on linux and unsure about your architecture you can run ``uname -m``.
